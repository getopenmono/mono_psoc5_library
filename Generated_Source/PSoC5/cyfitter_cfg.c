...
#define BS_UDB_0_3_1_CONFIG_VAL ((const uint8 CYFAR *)(0x48000970u + CYAPP_ECC_OFFSET))

/* UDB_1_1_0_CONFIG Address: CYDEV_UCFG_B1_P3_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)(0x480009F0u + CYAPP_ECC_OFFSET))

/* UCFG_BCTL0 Address: CYREG_BCTL0_MDCLK_EN Size (bytes): 16 */
#define BS_UCFG_BCTL0_VAL ((const uint8 CYFAR *)(0x48000A70u + CYAPP_ECC_OFFSET))

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)(0x48000A80u + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x48000A8Cu + CYAPP_ECC_OFFSET))

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)(0x48000A98u + CYAPP_ECC_OFFSET))

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)(0x48000AA4u + CYAPP_ECC_OFFSET))

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)(0x48000AACu + CYAPP_ECC_OFFSET))

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)(0x48000AB4u + CYAPP_ECC_OFFSET))
