...
#define BS_UDB_1_2_1_CONFIG_VAL ((const uint8 CYFAR *)(0x48000708u + CYAPP_ECC_OFFSET))
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)(0x480007A8u + CYAPP_ECC_OFFSET))

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)(0x480007B4u + CYAPP_ECC_OFFSET))
